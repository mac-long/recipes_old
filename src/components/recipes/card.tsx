...
export default function RecipeCard({
  ...
  return (
    <div className="flex flex-col justify-start p-2 max-w-xl rounded-md bg-gray-400 animate-pulse h-[144px]">
      <div className="flex gap-x-4 items-center text-xs lg:items-start">
        <time className="text-gray-500 w-[94px] h-[16px] bg-gray-200 animate-pulse rounded-md" />
        <div className="flex justify-center items-center space-x-1 w-[62px] h-[28px] bg-gray-200 animate-pulse rounded-full" />
      </div>
      <div className="flex relative flex-col justify-between h-full cursor-pointer group">
        <h3 className="mt-3 text-lg font-semibold leading-6 group-hover:text-indigo-600 bg-gray-200 w-[200px] h-[30px] text-gray-200 rounded-md animate-pulse">
          Some placeholder title
        </h3>
        <p className="mt-3 text-sm leading-6 text-gray-200 w-[350px] h-[20px] bg-gray-200 rounded-md animate-pulse"></p>
      </div>
    </div>
  );
}
