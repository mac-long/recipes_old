...
export default function RecipeCard({
  ...
  if (!loading) {
    ...
    return (
      <div className="flex flex-col justify-start p-2 max-w-xl rounded-md bg-gray-300 animate-pulse h-[144px] md:h-[169px]">
        <div className="flex gap-x-4 items-center text-xs">
          <time className="text-slate-500 w-[94px] h-[16px] bg-gray-200 animate-pulse rounded-md md:w-[75px] md:h-[32px]" />
        ...
        <div className="flex relative flex-col justify-between h-full">
          <h3 className="mt-3 text-lg font-semibold leading-6 bg-gray-200 w-[200px] h-[20px] text-slate-200 rounded-md animate-pulse md:w-[153px] md:h-[25px]" />
          <p className="text-sm leading-6 text-slate-200 w-[350px] h-[20px] bg-gray-200 rounded-md animate-pulse md:w-[153px] md:h-[45px]" />
        </div>
      </div>
    );
  }
